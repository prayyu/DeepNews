package com.example.myapplication.ui.brief;
...
public class DailyBriefActivity extends AppCompatActivity {
    ...
    private static final String PREF_NAME = "deepnews_prefs";
    private static final String KEY_BRIEF = "daily_brief";
    private static final String KEY_BRIEF_DATE = "brief_date";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView backBtn = findViewById(R.id.brief_back);
        ...
        // 先显示缓存的简报
        String cachedDate = prefs.getString(KEY_BRIEF_DATE, "");
        String cachedBrief = prefs.getString(KEY_BRIEF, "");
    ...
    private void generateBrief() {
        ...
        new Thread(() -> {
            try {
                ...
                String today = java.text.SimpleDateFormat.getDateInstance().format(new java.util.Date());
                prefs.edit()
                        .putString(KEY_BRIEF, text)
                        .putString(KEY_BRIEF_DATE, today)
                        .apply();
